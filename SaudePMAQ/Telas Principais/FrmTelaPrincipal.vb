...
#Region "Botão abre formulario"
    ...
    End Sub
    Private Sub BtnPRelatorio_Click(sender As Object, e As EventArgs) Handles BtnPRelatorio.Click
        AbrirFormEnPanel(Of FrmMenuRelatorio)()
    End Sub

    Private Sub BtnPDashBoard_Click(sender As Object, e As EventArgs) Handles BtnPDashBoard.Click
        AbrirFormEnPanel(Of FrmMenuDashBoard)()
    End Sub
#End Region
End Class